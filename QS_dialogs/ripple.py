...
class RippleFitDialog(QDialog):
    def __init__(self, parent, selected_files, network_service=None):
        ...
        try:
            ...
            for file_name in self.selected_files:
                try:
                    ...
                    s_params = self._get_param_matrix(file_name, "S参数")
