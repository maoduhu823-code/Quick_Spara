...
# 不同系统下的共享授权文件位置。会按顺序尝试，读到第一个有效 JSON 即停止。
# Windows UNC 示例：r"\\192.168.1.10\QuickSparam\license.json"
# HTTP 示例： "http://192.168.1.10/quick_sparam/license.json"
# Linux 示例： "/data/Storage_pisi/w00810255/Qs/license.json"
LICENSE_SOURCES_BY_PLATFORM = {
    ...
    "linux": [
        # TODO: 改成 Linux 环境可访问的服务器路径。
        "/data/Storage_pisi/w00810255/Qs/Public/license.json",
    ],
    "default": [],
}
